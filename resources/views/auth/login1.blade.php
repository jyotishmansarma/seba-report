...
@section('content')
  ...
  box-shadow:  0 10px 8px 0 rgba(0, 0, 0, 0.2), 0 10px 20px 0 rgba(0, 0, 0, 0.19)">
                    <div class="card-header" style=" text-align: center;display: block;"><img
                            src="{{asset("asset/images/icon/ahsec_logo.png")}}" alt="CoolAdmin" width="72" height="72">
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-0">
{{--                                <div class="row col-4 offset-md-5">--}}
