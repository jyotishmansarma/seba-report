...
class CenterListExport implements FromCollection, WithHeadings, WithEvents
{
    protected $data;
    protected $headings;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A1:Z1265')->getAlignment()->setVertical('center')->setWrapText(true);
                //Set the horizontal center of the area cell
                $event->sheet->getDelegate()->getStyle('A1:Z1265')->getAlignment()->setHorizontal('center')->setWrapText(true);
                ...
                $event->sheet->getDelegate()->setMergeCells(['D1:E1']);
